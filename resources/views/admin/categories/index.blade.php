        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 justify-content-between d-flex">
                    <h1 class="m-0">{{ __('Catégorie de Blog') }}</h1>
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form onclick="return confirm('Êtes-vous sûr ?');" class="d-inline-block" action="{{ route('admin.categories.destroy', [$category]) }}" method="post">
                                                @csrf 
                                                @method('delete')
