        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 d-flex justify-content-between">
                    <h1 class="m-0">{{ __('Formulaire d'Édition') }}</h1>
                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.blogs.update', [$blog]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" value="{{ old('title', $blog->title) }}" id="title" placeholder="exemple : 5 astuces de voyage">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                <label for="excerpt" class="col-sm-2 col-form-label">Extrait</label>
                                <div class="col-sm-10">
